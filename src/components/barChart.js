...
const BarChart = () => {
    ...
    let DATA = JSON.parse(localStorage.getItem('React-Bar-Chart')) ? JSON.parse(localStorage.getItem('React-Bar-Chart')) : [];
    ...
    const addData = () => {
        ...
        localStorage.setItem('React-Bar-Chart',JSON.stringify(storedValue))
