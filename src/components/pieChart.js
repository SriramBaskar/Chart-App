...
const PieChart = () => {
    ...
    let DATA = JSON.parse(localStorage.getItem('React-Pie-Chart')) ? JSON.parse(localStorage.getItem('React-Pie-Chart')) : [];
    ...
    const addData = () => {
        ...
        localStorage.setItem('React-Pie-Chart',JSON.stringify(storedValue))
